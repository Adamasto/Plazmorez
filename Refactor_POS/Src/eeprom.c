...
uint16_t EE_Init(void)
{
  ...
  switch (PageStatus0)
  {
    case ERASED:
      ...
      {
				FLASH_Erase_Sector(SECTOR_1, FLASH_VOLTAGE_RANGE_3);
      }
...
//        FlashStatus = FLASH_ProgramHalfWord(PAGE1_BASE_ADDRESS, VALID_PAGE);
    ...
    case RECEIVE_DATA:
      if (PageStatus1 == VALID_PAGE) /* Page0 receive, Page1 valid */
      {
        ...
        //FlashStatus = FLASH_ProgramHalfWord(PAGE0_BASE_ADDRESS, VALID_PAGE);			
				...
				FLASH_Erase_Sector(SECTOR_2, FLASH_VOLTAGE_RANGE_3);
        //FlashStatus = FLASH_EraseSector(SECTOR_2, VoltageRange_3);
    ...
    case VALID_PAGE:
      ...
      else /* Page0 valid, Page1 receive */
      {
       ...
       // FlashStatus = FLASH_ProgramHalfWord(PAGE1_BASE_ADDRESS, VALID_PAGE);
				FLASH_Erase_Sector(SECTOR_1, FLASH_VOLTAGE_RANGE_3);
        //FlashStatus = FLASH_EraseSector(SECTOR_1, VoltageRange_3);
      }
      break;
...
static uint16_t EE_PageTransfer(uint16_t VirtAddress, uint16_t Data)
{
  ...
  uint8_t NewSector = 0, OldSector = 0;
  ...
  if (ValidPage == PAGE1)       /* Page1 valid */
  {
    ...
    NewSector = SECTOR_1;
	//  NewPageAddress = SECTOR_1;
    /* Old page address where variable will be taken from */
    OldPageAddress = PAGE1_BASE_ADDRESS;
    OldSector = SECTOR_2;
	 // OldPageAddress = SECTOR_2;
  }
  else if (ValidPage == PAGE0)  /* Page0 valid */
  {
    ...
    NewSector = SECTOR_2;
   // NewPageAddress = SECTOR_2;
    /* Old page address where variable will be taken from */
    OldPageAddress = PAGE0_BASE_ADDRESS;
    OldSector = SECTOR_1;
   // OldPageAddress = SECTOR_1;
  }
  else
  {
    return NO_VALID_PAGE;       /* No valid Page */
  ...
  for (VarIdx = 0; VarIdx < NumbOfVar; VarIdx++)
  {
	...
	FLASH_Erase_Sector(OldSector, FLASH_VOLTAGE_RANGE_3);
 //FlashStatus = FLASH_EraseSector(OldSector, VoltageRange_3);
